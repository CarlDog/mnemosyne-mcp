...
- **Open threads as one-click directions.** Ours alone, and the best idea in
  ...
  story-14 and story-08; GhostHunters' unmatched mirror, unlocated circle
...
them. Only Story 03 and GhostHunters are contemporary enough for it to land.
...
| Ours — the Story 03 reader artifact | — | Already audience mode; adopt it wholesale |
