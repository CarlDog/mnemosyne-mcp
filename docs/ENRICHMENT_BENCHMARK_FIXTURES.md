...
**Coverage gap, not filled in:** `story-04` has zero played
...
- **Excluded entities:** Character 137, Character 051, Wisp, Character 145
...
- **Expected entities:** Character 137; Lilith
- **Excluded entities:** Character 051, Wisp — the direction names its
...
- **Expected entities:** Character 051; The Reach Below (Character 138,
  Fenna "Spark" Darrin weren't in the research pass's read list — confirm
  their exact canon names before using this fixture)
- **Excluded entities:** Lilith, Character 137, Wisp — a control case; if
...
Entities in this scene: **Character 056**, **Character 049**. No one
else. Six canon entities (Brass Guild Hall, Character 016,
Character 006, Ada Pell, Moira Brindle, Dr. Leda Winn) exist in
...
- **Expected entities:** Character 056; Character 049; Briar House
- **Excluded entities:** Character 118 (off-page since scene 10, not in the
  anchor scene); Character 016, Character 006, Ada Pell,
...
- **Expected entities:** Character 118; Character 056; Character 049
...
- **Expected entities:** Character 056; Character 049
...
Entities in this scene: **Character 114**, **Character 130**, **Character 120**,
**Chaos House**.
...
- **Direction:** `continue`
- **Category:** vague (normalized set)
- **Expected entities:** Character 114; Character 130; Character 120; Chaos House
- **Excluded entities:** Character 086 ("has not appeared on-page in the
...
- **Expected entities:** Character 121; Character 130
- **Excluded entities:** Character 086, Character 078 — neither is named
...
- **Category:** explicit/rich
- **Expected entities:** Character 114; Character 130; Character 065
- **Excluded entities:** Character 086, Character 121, Character 078
...
Entities in this scene: **Character 072**, **Character 088**, **Heather
...
- **Direction:** `continue`
- **Category:** vague (normalized set)
- **Expected entities:** Character 072; Character 088; Character 035;
  Blackwood Manor — **and, genuinely unresolved: Elizabeth Blackwood /
  Constance / Persephone?**
- **Excluded entities:** Character 084 (hospitalized, off-page but not
...
- **Category:** vague-length (12 chars) but names a known entity ("Carl")
  — should classify as NOT vague
- **Expected entities:** Character 084
...
- **Category:** explicit/rich
- **Expected entities:** Character 072; Character 088; Character 035;
  Blackwood Manor; Character 075
- **Excluded entities:** Character 084, the historical Trinity, the three
...
- **Direction:** `Character 141 briefs Tinkerbell on the Seven Hearths network before the archive run`
- **Category:** explicit/rich
- **Expected entities:** Character 141; Tinkerbell; The Seven Hearths
...
|---|---|---|---|
| BTC-1 | story-01 | vague | recall + no spurious second-party pull-in |
| BTC-2 | story-01 | short-rich negative | entity-name condition |
| BTC-3 | story-01 | explicit control | enrichment stays off |
| BN-1 | story-02 | vague | unwanted persistence (6 never-appeared entities) |
| BN-2 | story-02 | short-rich negative | entity-name condition, off-page-not-exited |
| BN-3 | story-02 | explicit control | judgment call flagged (Guild inspection) |
| CS-1 | story-03 | vague | unwanted persistence (1 clean exit) |
| CS-2 | story-03 | short-rich negative | judgment call flagged (Kira, nomadic not exited) |
| CS-3 | story-03 | explicit control | — |
