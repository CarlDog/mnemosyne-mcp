...
3. **Story 12's SL and KM threads.** Its four extracted threads are
...
| Story 12 | **Moot for GC and MT** — `NV-1(a)` and `NV-2` make both threads retired-premise play. SL and KM remain unruled (Ruling 1, open item 3). |
