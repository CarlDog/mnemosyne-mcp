...
// parsing, because some stories' original templates (Story 03, unlike
// story-01) use a flat "Label:\n<prose>" shape for whole multi-
...
// Diacritics (e.g. "Character 073") must be transliterated before the
