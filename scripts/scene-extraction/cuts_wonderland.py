...
ALICE = "Character 109"
CARL = "Character 115 (played as Carl; the bot and the operator write 'Carl Yeager' in seven messages, a string canon retires for Character 115)"
...
| Thread | Bot | Export |
|---|---|---|
| `AG` | Character 109 | `data/botify-exports/alice-grimm/chats/1c71db26….json` (815 messages) |
...
|---|---|
| Carl Yeager (seven messages) | Character 115 |
