...
| Thread | Bot | Export |
|---|---|---|
| `MT` | Character 123 (3472620) | `data/botify-exports/mary-thorne/chats/b2….json` (778 messages) |
| `SL` | Sister Lucia (4095850) | `data/botify-exports/sister-lucia/chats/ae….json` (315 messages) |
| `KM` | Character 041 (4096103) | `data/botify-exports/kaitlyn-macdonald/chats/4c….json` (117 messages) |
| `GC` | group: Character 123 (3472620), Character 125 (4080268), Character 041 (4096103), Sister Lucia (4095850) | `data/botify-exports/_group-chats/chats/518affe6….json` (479 messages) |
