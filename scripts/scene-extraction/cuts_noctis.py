...
MT = dict(
    ...
    participants_basis="rule-derived from the prose; played names map to canon's Character 110, Character 024, Character 039, Sister Beatrice Quill, and Sister Margaret Hale (canon/characters/_minor.md); Father Yeager is the operator's own name in a role canon's provenance calls not canon; verify before relying on it",
    scenes=[
