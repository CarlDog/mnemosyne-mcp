...
AN = dict(
    ...
    participants_basis="rule-derived from the prose; played first names map to canon's Character 104, Camille Ortiz, and Dr. Elias Renshaw (canon/characters/_minor.md) where the source's Renshaw is a woman; Dr. Yeager is the operator's own name, which canon's provenance excludes; verify before relying on it",
    scenes=[
