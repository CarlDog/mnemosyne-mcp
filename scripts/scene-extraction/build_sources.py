...
STORIES = {
    "story-03": dict(
        ...
        external=[group("4f6af160", "the 'Jenna and Riley' group chat; " + CUT + " as CS-GC-01-WHP, unplaced"),
                  chat("jenna-maren", "1477a398", "Character 120 private chat; " + UNREVIEWED),
                  chat("riley-quinn", "deeaa24f", "Character 130 private chat; " + UNREVIEWED)]
        + folder("data/stories/story-03/exports/raw-chatgpt-shares", "ChatGPT share-chat captures; the project documents recovered from them are under drafts/_control/source-documents/")
        + folder("data/stories/story-03/companion-logs", "watch-companion transcript captures (see docs/DATA_LAYOUT.md, Companion logs)", "companion-log"),
    ...
    "story-01": dict(
        title="story-01",
        external=folder("data/stories/story-01/exports/raw-chatgpt-shares", "ChatGPT share-chat captures; the Chapter One scenes and the pasted configuration documents recovered from them are under drafts/ and drafts/_control/scenes/"),
    ...
    "story-02": dict(
        title="Brass & Nerve",
        external=[chat("evelyn-starling", "d3212413", "the Character 056 private chat; " + CUT + " (12 BN-* scenes)")],
    ...
    "story-09": dict(
        ...
        external=[chat("mara-jade", "0816c2f7", "the Character 143 private chat; " + CUT + " (BL-MJ-*)"),
    ...
    "story-10": dict(
        ...
        external=[chat("eroica", "413c48c9", "the Eroica private chat; " + CUT + " (AP-ER-*)"),
                  chat("andrea-neal", "70bee458", "the Character 111 / V1X3N private chat; " + CUT + " (AP-AN-*)"),
                  chat("dr-aurora-lumen", "ad5c71e2", "the Character 048 private chat; " + CUT + " (AP-AL-*)"),
                  group("3de009c8", "the 'Eroica, Character 048, Charisma' group chat; " + CUT + " (AP-GC-*)"),
    ...
    "story-12": dict(
        title="Story 12",
        external=[group("518affe6", "the 'Mary and Character 125' group chat, the provenance's primary source; " + CUT + " (NV-GC-*)"),
                  chat("mary-thorne", "b29b647c", "the Character 123 private chat; " + CUT + " (NV-MT-*)"),
                  chat("sister-lucia", "ae928207", "the Sister Lucia private chat; " + CUT + " (NV-SL-*, cut at #0312)"),
                  chat("kaitlyn-macdonald", "4cc3573f", "the Character 041 private chat; " + CUT + " (NV-KM-*)"),
                  chat("noctis-veil", "6a02953f", "Character 125 private chat, named as a companion definition source by SOURCE_PROVENANCE.md; not extracted"),
                  group("74601077", "'The Sleepover' group chat (The O'Hara Sisters, Character 041); " + UNREVIEWED),
                  group("95f5f655", "'The Retreat' group chat (Kelsey Chambers, Character 123, Alexandra and Ava, Character 041, Lilith); " + UNREVIEWED)],
        note="No ChatGPT project existed for this story; its originals are the Botify exports listed in the manifest.",
    ),
    "story-14": dict(
        title="story-14",
        external=[chat("alice-grimm", "1c71db26", "the Character 109 private chat; " + CUT + " (23 WL-AG-* scenes)")],
    ...
    "story-04": dict(
        ...
        external=[group("e15f3c21", "'Not Your Average Fairy Tale' group chat, the provenance's primary Botify source; not extracted into scenes"),
                  group("19312508", "'Mischief' group chat (Character 141, Cinderella, Belle, Tinkerbell), Tinkerbell's source lineage; not extracted"),
                  chat("belle", "57bf280a", "Belle private chat; " + UNREVIEWED),
                  chat("cinderella", "94a7c5d8", "Cinderella private chat; " + UNREVIEWED),
                  chat("snow-white", "243803ae", "Character 141 private chat; " + UNREVIEWED),
