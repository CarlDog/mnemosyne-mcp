...
MARA = "Character 143"
VEYR = "Character 128 (played as 'Master Character 137'; the bot also writes 'Karl', 'Carl Yeager', and 'Carl'; canon retires every one of those names for Character 128)"
...
|---|---|
| "Master Character 137", "Karl", and the bot's slips "Carl Yeager" (`#0088`) and "Carl" (`#0200`-`#0203`) | **Character 128**. `recovered-botify-continuity…` rules that the retired names are not aliases and "must not appear in new canon prose except in provenance audits"; the platform-name slip is the failure mode `dossier-contradictions-and-identity-noise.md` already names. |
