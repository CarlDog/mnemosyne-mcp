...
node ../../scripts/verify-draft-overlay.mjs story-12   # from the repo root
```
...
`cuts_story-14.py`, `cuts_chaos.py`.
...
Case, and story-08 cuts (same rules, one chat each), the Story 03
