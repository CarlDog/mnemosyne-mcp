...
SH = r"D:\GitHub\mnemosyne-mcp\data\stories\story-03\exports\raw-chatgpt-shares"
OUT = r"D:\GitHub\mnemosyne-mcp\data\stories\story-03\drafts\_control\source-documents"
...
for o in d1:
    ...
    save(f"canon-tracking-directive-v{n}.md", f"Canon Tracking Directive, version {n} (Boundary-Pushing chat)", B, o["start"], o["end"], o["text"],
         "canon-tracking-directive", "Defines the Timeline File and Story Beats Log formats; the worked examples are GhostHunters entries, and no Story 03 log content exists in any export")
for o in d2:
    n += 1
