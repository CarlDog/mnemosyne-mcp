...
RAW = os.path.join(REPO, "data", "archive", "chatgpt", "Story 03", "Chat", "Archived", "Raw", "Story 03 3.txt")
OUT = r"D:\GitHub\mnemosyne-mcp\data\stories\story-03\canon\scenes\_alternates"
...
for it in items:
    ...
    fm += ['source_original_file: "Story 03 3.txt"', f"source_lines: \"{it['a']}-{it['b']}\"",
...
idx = ["# Raw 3 alternates", "", "Non-canon scene prose from `Story 03 3.txt`: style-guide samples, template placeholders, and superseded drafts of canon scenes. Files here are ignored by the validator and compiler and never import. See `README.md` in this folder.", "",
