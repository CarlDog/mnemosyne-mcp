"""Cut the Brass & Nerve Botify transcript (Character 056 private chat) into
per-scene draft files under drafts/scenes/ as overlay add operations.

Usage: python extract_brass_scenes.py [--write]

Same invented delineators as The Blackwood Case and story-08: a new scene
...
EVELYN = "Character 056"
ELIZA = "Character 049"
GIDEON = "Character 118 (played as Carl, the operator's own name; canon retires that identity)"
...
def render_scene(s):
    fm = [
        ...
        "participants_basis: " + jstr("rule-derived: Evelyn is the bot and in every scene; Eliza from the foyer onward; the patient only in the scenes he is in the room for (he is spoken of in the others). The patient is played under the operator's own name, which canon retires in favour of Character 118; verify before relying on it"),
        "pov: " + jstr("Botify private chat with the Character 056 bot: the bot writes Evelyn in first and third person and, from the foyer onward, also voices Eliza; the operator plays the patient in first person and, from #0111, writes Eliza's lines and stage directions as well; operator turns are listed in operator_turns and kept as written"),
