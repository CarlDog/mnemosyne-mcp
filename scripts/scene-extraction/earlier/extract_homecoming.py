...
SRC = os.path.join(REPO, "data", "stories", "story-03", "exports", "raw-chatgpt-shares", f"{SID}.txt")
SRC_REL = f"data/stories/story-03/exports/raw-chatgpt-shares/{SID}.txt"
SCENES = os.path.join(REPO, "data", "stories", "story-03", "canon", "scenes")
...
def parts_of(text):
    names = [("Carl", "Character 114"), ("Riley", "Character 130"), ("Jenna", "Character 120")]
