...
"""Cut the story-08 Botify transcript (Dark Queen Lilith private chat) into
per-scene draft files under drafts/scenes/ as overlay add operations.

Usage: python extract_story-08_scenes.py [--write]
...
SCENES = [
    ...
    ("SF-D01-01-THR", "Character 030", 0, "THR",
    ...
    # ---- Day 3: the story-08 Ruby, the grimoire, the experiment ----------
    ("SF-D03-01-BAL", "The story-08 Ruby", 164, "BAL",
    ...
    ("SF-D03-03-BAL", "The story-08 Heart", 227, "BAL",
     "Day 3, night, the balcony", "established", ["RUBY_RENAMED_story-08_HEART"], []),
    ...
    ("SF-D06-17-PCH", "The Black Rose", 1610, "PCH",
     ...
     ["KARLS_NOTE_QUOTED_VERBATIM", "LILITH_VOWS_TO_BIND_KARL", "AMULET_MEANS_THE_story-08_RUBY_HERE"], []),
...
CANON_NAMES = {
    "Lilith": "Character 074",
    "Jäger": "Character 030",
    "Karl": "Character 030",
    "Rosemary": "Character 071 (played as Rosemary Worthington)",
    "Isolde": "Character 066 (played as Isolde Fairfax)",
    "Briar": "Character 020 (played as Briar Rose Blackwood)",
    "Seraphina": "Character 046 (played as Seraphina Thorne)",
    "Reginald": "Reginald",
}
...
def main():
    ...
    open(os.path.join(SCRATCH, "story-08-scenes-dryrun.tsv"), "w", encoding="utf-8", newline="\n").write("\n".join(rows) + "\n")
    print("\n".join(rows))
