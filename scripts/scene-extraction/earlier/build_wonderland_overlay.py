...
"""Generate the story-14 Living Canon r10 draft overlay from active canon.
...
ROOT = r"D:\GitHub\mnemosyne-mcp\data\stories\story-14"
CANON = os.path.join(ROOT, "canon")
DRAFTS = os.path.join(ROOT, "drafts")
BANNER = "> **DRAFT — NOT ACTIVE CANON**\n\n"
PREFIX = "data/stories/story-14/references/"
...
- **Long-term want:** her sanity, her name, and "something smaller than hope, but harder to kill." She is not trying to save story-14; she is trying to leave with herself intact.
...
- **Capabilities:** ten years of survival habit, story-14 pattern-reading, the Keyblade's edge and its reactions, and the discipline to stay polite while cursing.
...
- **Long-term want:** none is established. He has not been in story-14 long enough to form one, and the profile deliberately leaves his civilian years open; do not supply an aim for him.
...
## Wants & Pressure
- **Want:** to solve the riddle, because he believes, without remembering why, that solving it might stop story-14 from unraveling, or him.
...
## Wants & Pressure
- **Want:** Alice contained and corrected, and story-14 returned to a pattern she can read. She believes order is salvation.
...
ROUTING_OLD = ("Content capability is handled by Mnemosyne's SFW/NSFW text and image routing. "
               ...
               "story-14 must not be silently sanitized after generation begins.")
ROUTING_NEW = ("Content capability belongs to Mnemosyne's operational routing layer, not to story "
               ...
               "transparently; story-14 must not be silently sanitized after generation begins.")
...
- **Observed:** story-14 has rewritten itself by slow unraveling: whimsy to obedience, names erased, stories rewritten (*story-14*).
...
- **Bloom:** a dated record, a memory not hers, or a denizen who remembers story-14 before her.
...
- **Inferred (Alice):** just a tool. **Inferred (record):** ward, compass, failsafe, memory, a sliver of story-14 before the madness.
...
def main():
    ...
    manifest = {"schema_version": 2, "story_slug": "story-14", "files": files}
