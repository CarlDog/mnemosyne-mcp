...
GC = dict(
    code="GC", label="\"Jenna and Riley\" group chat (bots 3150743 Character 120, 3155028 Character 130; chat 4f6af160…)", group=True,
    ...
    pov="Botify group chat: the Character 120 and Character 130 accounts write their own characters in third person; the operator plays Carl in first person (thirteen turns, labelled Operator) and closes the export with a summary turn; every message carries its export speaker label",
...
STORY = dict(
    slug="story-03", prefix="CS", title="Story 03", cut_date="2026-09-02",
    ...
    media_note="",
    readme="""# Story 03 — the "Jenna and Riley" Botify group chat
...
group chat that might be usable in Story 03". It sits beside, and does not
...
(`**Character 120:**`, `**Character 130:**`, and the neutral `**Operator:**` for
